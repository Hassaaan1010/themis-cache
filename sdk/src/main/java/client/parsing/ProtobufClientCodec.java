...
public class ProtobufClientCodec implements Codec<RequestProtos.Request, ResponseProtos.Response>{
    @Override
    public ChannelInboundHandler newDecoder() {
        //Handles input ResponseProto.Response messages
        return new ProtobufDecoder(ResponseProtos.Response.getDefaultInstance());
    }

    @Override
    public ChannelOutboundHandler newEncoder() {
        // Handles outbound RequestProtos.Request messages
        return new ProtobufEncoder();
    }
}
