...
public class EchoServer {
    ...
    public void start() throws Exception {
        ...
        workerGroup = new NioEventLoopGroup(); // handle traffic
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
                    ...
                    // listner channel (parent) allow to specify handler for accepted channels
                    // (children)
    ...
    public static void main(String[] args) throws Exception {
        EchoServer server = new EchoServer(CommonConstants.SERVER_PORT);
